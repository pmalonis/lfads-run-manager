...
par.c_ic_dim = 200;
par.c_do_causal_controller = true;
par.c_controller_input_lag = 1;
par.c_output_dist = 'poisson';
par.c_keep_prob = 0.98;
par.c_con_dim = 128;
par.c_l2_con_scale = 2000;
par.c_l2_gen_scale = 500;
par.c_factors_dim = 40;
parSet = par.generateSweep('c_l2_con_scale', [500 2000], 'c_do_causal_controller', [false true], 'c_kl_co_weight', [1 2]);
