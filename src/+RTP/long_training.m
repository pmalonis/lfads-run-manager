...
rc = RTP.RunCollection(runRoot, 'long_training', dc);
...
par.c_learning_rate_stop = 1e-6; % we can stop training early for the demo
par.c_ic_dim = 200;
...
parSet = par.generateSweep('c_co_dim', [2], 'c_kl_co_weight', [2 2.5]);
